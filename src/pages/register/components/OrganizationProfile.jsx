...
function OrganizationProfile() {
  ...
  return (
    <div
      className={
        !id
          ? `flex flex-col items-center justify-start min-h-screen pt-24 pb-10 px-4 bg-white`
    ...
    >
      ...
      <form
        ...
        className={
          !id
            ? `w-full max-w-[80%] bg-white px-6 py-6 space-y-6 shadow-md rounded-b-xl`
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-6">
          ...
          <div>
            ...
            {errors.payRange && (
              <p className="text-red-500 text-sm">{errors.payRange.message}</p>
            )}
          </div>
        </div>
        <div>
