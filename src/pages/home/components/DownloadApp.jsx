      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 mt-2">
            <div className="flex items-center w-60 border border-gray-300 rounded-xl px-4 py-3 bg-white">
            ...
            <button
              className="bg-[#00A4E1] text-white px-6 py-3 rounded w-28 h-12 font-medium text-sm hover:bg-[#0086b8] transition"
            >
              Send SMS
            </button>
          </div>
